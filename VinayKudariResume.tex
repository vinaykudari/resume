...
\section{Education}
    \resumeSubHeadingListStart
        ...
        \resumeSubheading
          {National Institute of Technology, Durgapur [7.5/10]}{West Bengal, India}
...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\textrm{Data Structures \& Algorithms, Machine Learning, Reinforcement Learning, Computer Vision \& Image Processing, NLP}
\end{tabular*}
...
\section{Relevant Projects}
    \resumeSubHeadingListStart
        \projectheading{Optical Character Recognition | Computer Vision}{}{}
        \resumeItemListStart
            \resumeItemClean
                {Developed OCR system from scratch, using connected component analysis and feature descriptors SIFT, Hu Moments}
        \resumeItemListEnd
        \projectheading{Social Unrest Prediction | NLP}{}{}
        \resumeItemListStart
            \resumeItemClean
                {Augmented ACLED dataset with data from Twitter and NewsAPI and indexed in Solr}
            \resumeItemClean
                {Exploring encoder-decoder seq2seq models to generate stance for the event prediction task}
        \resumeItemListEnd
        ...
        \projectheading{Vehicle Health Inspector API | Computer Vision, Deep Learning}{\href{https://finddentsonmycar.tech/}{link}}{}
            \resumeItemListStart
                \resumeItemClean
                    {Trained segmentation model using Detectron2 to detect damage and calculate health score; Deployed model as a REST API on GCP}
            \resumeItemListEnd
