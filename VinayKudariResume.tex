...
\section{Experience}
  ...
  \resumeSubheading{Sony (Playstation)}{San Francisco, CA}
    {Software Development Intern  \(|\) \textbf{java, spring, kafka, grafana, grpc, no-sql, cassandra}}{May 2022 - Present}
    \resumeItemListStart
        \resumeItemClean
    ...
    {Big Data Developer \(|\) \textbf{python, redshift, pyspark, pandas, aws, distributed-computing}}{Sep 2018 - Dec 2019}
    \resumeItemListStart
        \resumeItemClean
