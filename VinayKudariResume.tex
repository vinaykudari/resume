...
\section{Relevant Projects}
    \resumeSubHeadingListStart
        ...
        \projectheading{Vehicle Health Inspector API | Computer Vision, Deep Learning}{\href{https://finddentsonmycar.tech/}{link}}{}
            \resumeItemListStart
                \resumeItemClean
                    {Trained segmentation model based on Mask-R-CNN architecture to segment damaged areas and calculate health score}
            \resumeItemListEnd
        \projectheading{DeepJet Autonomous Car | Deep/Reinforcement Learning, App Dev, Backend}{\href{https://github.com/vinaykudari/eureka-bot}{link}}{}
            ...
            \resumeItemListEnd
        \projectheading{Mask Detection REST API | Computer Vision, Deep Learning, Backend }{\href{}{}}{}
            \resumeItemListStart
                \resumeItemClean
                    {Developed mask detector model using Yolo to detect faces and fine tuned ResNet to detect masks on faces}
		\resumeItemClean
		    {Deployed model as serverless deep-learning REST API in Cloud Run with automated build pipeline setup using Cloud Build}
            \resumeItemListEnd
    \resumeSubHeadingListEnd
