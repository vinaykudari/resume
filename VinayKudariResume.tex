...
\section{experience [3.4 yrs]}
  ...
  \resumeSubheading{Sony (Playstation) [3 mon]}{San Francisco, CA}
    ...
    {Full Stack Developer \(|\) \textbf{python, django, flutter, pytest, redis, celery, gcp, k8s}}{Jan 2020 - Aug 2021}
    \resumeItemListStart
        \resumeItemClean
    ...
    {Big Data Developer \(|\) \textbf{python, redshift, pyspark, pandas, aws}}{Sep 2018 - Dec 2019}
    \resumeItemListStart
        \resumeItemClean
    ...
    {Computer Vision Intern \(|\) \textbf{opencv, video processing, scikit-learn}}{May 2017 - July 2017}
    \resumeItemListStart
        \resumeItemClean
...
\vspace{2pt}
\resumeSubItem{Microservice based deeplearning inference pipeline \(|\) docker, cloud-run, automation}{Created face mask dataset and trained a multiclass classification network; Exposed ResNet model in a docker container; setup automated CI/CD pipeline to build and deploy as serverless REST API}
\vspace{2pt}
