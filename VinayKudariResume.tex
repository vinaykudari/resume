...
\begin{tabular*}{\textwidth}{@{}l@{\extracolsep{\fill}}r@{}}
  ...
  \textit{Interested in systems that shape user behavior at scale} & +1-469-943-6778 \\
\end{tabular*}
...
\section{Relevant skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{ML \& Deep Learning}{: PyTorch, JAX, Hugging Face, PySpark} \\
     \textbf{GenAI \& Agents}{: LangGraph, vLLM, QLoRA, RAG} \\
     \textbf{Ranking \& Search}{: ANN, Embeddings, Contrastive learning} \\
     \textbf{Infra \& Backend}{: Kubernetes, FastAPI, Redis, Snowflake, GCP, AWS}
    }}
 \end{itemize}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    {Machine Learning Engineer  \(|\) \textbf{fine-tuning, inference, agents}}{July 2024 - Present}
    \resumeItemListStart
        \resumeItemClean
 ...
 {Engineered an LLM-driven, multi-agent CI/CD pipeline that automates developer onboarding by dynamically reviewing uploaded codebases for syntax and security vulnerabilities before autonomously merging and creating pull requests.}
  ...
  \resumeSubheading{Gap Inc}{San Francisco, CA}
    {Software Engineer  \(|\) \textbf{ranking, retrieval, e-commerce}}{July 2023 - June 2024}
    \resumeItemListStart
        \resumeItemClean
 {Engineered a real-time Click-Through Rate (CTR) prediction model using XGBoost to dynamically rank and serve personalized credit card advertisements; integrated user behavioral features, coupon usage, and credit eligibility proxies to optimize ad placement.}
        \resumeItemClean
  ...
  \resumeSubheading{Amazon Web Services}{Palo Alto, CA}
    {Software Development Engineer  \(|\) \textbf{big-data, etl, pyspark, athena, dynamodb}}{Dec 2022 - June 2023}
    \resumeItemListStart
        \resumeItemClean
    ...
    {Founding engineer \(|\) \textbf{mobile-app, web-app, django, flutter}}{Jan 2020 - Aug 2021}
    \resumeItemListStart
        \resumeItemClean
