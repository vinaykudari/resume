...
\section{Relevant skills}
	{Python, SQL, JAVA, Go, Django, Flask, PyTorch, PySpark, Docker, Kubernetes, Git, OpenCV, GCP, AWS} 
\vspace{-2pt}
...
\section{Experience}
  ...
  \resumeSubheading{Sony (Playstation)}{San Francisco, CA}
    ...
    {Full Stack Developer \(|\) \textbf{python, go, django, flutter, pytest, redis, gcp, k8s}}{Jan 2020 - Aug 2021}
    \resumeItemListStart
        \resumeItemClean
