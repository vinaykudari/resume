...
\section{Experience}
  ...
  \resumeSubheading{Playstation (Sony)}{San Francisco, CA}
    {Software Development Intern  \(|\) \textbf{java, kafka, concurrency, async, no-sql, cassandra}}{05/23/2022 - Present}
    \resumeItemListStart
        \resumeItemClean
    ...
    {Full Stack Developer \(|\) \textbf{rest-api, django, mobile-app, pytest, redis, gcp, k8s}}{01/02/2020 - 08/30/2021}
    \resumeItemListStart
        \resumeItemClean
    ...
    {Big Data Developer \(|\) \textbf{redshift, pyspark, pandas, aws, distributed-systems}}{09/17/2018 - 12/27/2019}
    \resumeItemListStart
        \resumeItemClean
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Master of Science in Computer Science (AI/ML Specialization)}{08/31/2021 - Present}
    ...
    \resumeSubheading
      ...
      {Bachelor of Technology in Computer Science and Engineering}{07/12/2014 - 05/25/2018}
