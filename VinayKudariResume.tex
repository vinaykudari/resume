...
\section{Experience}
    ...
    \resumeSubheading
    	...
    	{Computer Vision Intern}{May 2017 -  July 2017}
    	    \resumeItemListStart
                \resumeItemClean
                  {Extracted frames from surveillance cameras; merged them based on SIFT keypoints and RANSAC; trained a support vector machine with a gaussian kernel to detect cargo class and estimate lease area; developed a motion detector model to identify suspicious movements}
    	    \resumeItemListEnd
    \resumeSubHeadingListEnd
