...
\section{Experience}
  ...
  \resumeSubheading{Sony (Playstation)}{San Francisco, CA}
    ...
    \resumeItemListStart
        ...
        \resumeItemClean
          {Developed a CLI tool to automate generation of grafana analytical dashboards from prometheus query logs}
        \resumeItemClean
          {Ported monolith news publisher service into micro service using gRPC based custom built framework}
        \resumeItemListEnd
