...
\section{Experience}
  ...
  \resumeSubheading{Playstation}{San Francisco, CA}
    ...
    \resumeItemListStart
        ...
        \resumeItemClean
          {Learned custom framework and leveraged asynchronous programming pattern to optimise the latency by 60\%}
        \resumeItemClean
          {Developed a cross platform CLI tool to automate generation of grafana analytical dashboards from logs}
	\resumeItemClean
	{Integrated Hibernate into LEGO framework; Transformed and optimised raw SQL to HQL queries}
        \resumeItemListEnd
