...
\section{experience [3.4 yrs]}
  ...
  \resumeSubheading{Sony (Playstation) [3 mon]}{San Francisco, CA}
    ...
    \resumeItemListStart
        \resumeItemClean
          {Working on a service which publishes hints to the online PS5 users dynamically based on the game context}
        \resumeItemClean
          {Porting monolith news publisher service into a async service using gRPC based custom built framework}
        \resumeItemClean
    ...
    {Full Stack Developer \(|\) \textbf{python, django, flutter, pytest, redis, async, gcp, k8s}}{Jan 2020 - Aug 2021}
    \resumeItemListStart
        \resumeItemClean
    ...
    {Big Data Developer \(|\) \textbf{python, redshift, pyspark, pandas, aws, scikit-learn}}{Sep 2018 - Dec 2019}
    \resumeItemListStart
        \resumeItemClean
          {Time series analysis was conducted on drug assay data to identify raw materials that effect the drug quality}
        \resumeItemClean
          {Designed ETL data validation pipeline using microservice architecture; Manual testing resources were cut by 70\%}
        \resumeItemClean
    ...
    {Computer Vision Intern \(|\) \textbf{opencv, computer vision}}{May 2017 - July 2017}
    \resumeItemListStart
        \resumeItemClean
