...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{{\LARGE Vinay Kudari}} & \href{mailto:}{jobs.vinaykudari@gmail.com}\\
  \href & +1-469-943-6778
\end{tabular*}
...
\section{Experience}
  ...
  \resumeSubheading{Gap Inc}{San Francisco, CA}
    {Sr. Software Engineer  \(|\) \textbf{java, spring boot, graphql, langchain, llm, k8s, chatbot}}{July 2023 - Present}
    \resumeItemListStart
        \resumeItemClean
          {Engineering a low-latency LLM-based information retrieval system to extract data from a heterogeneous, multi-source large document corpus}
        \resumeItemClean
          {Leading the development of a GraphQL based data access layer to retrieve data from a data lake}
       \resumeItemListEnd
