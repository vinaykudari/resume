...
\section{Relevant skills}
	{\textbf{Python, Go, JAVA, SQL}, \textit{Django, Flask, Spring, PySpark, Docker, Kubernetes, Git, Redis, Kafka}, \textbf{GCP, AWS}}
\vspace{-2pt}

\section{Experience}
  \resumeSubHeadingListStart
  \resumeSubheading{Playstation (Sony)}{San Francisco, CA}
    {Software Development Intern  \(|\) \textbf{java, kafka, jenkins, concurrency, no-sql, cassandra}}{May 2022 - Present}
    \resumeItemListStart
        \resumeItemClean
    ...
    {Full Stack Developer \(|\) \textbf{rest-api, flutter, gitlab, pytest, redis, gcp, k8s}}{Jan 2020 - Aug 2021}
    \resumeItemListStart
        \resumeItemClean
            {Developed API templates and cross platform application layers to accelerate development lifecycle}
          \resumeItemClean
...
\section{Projects}
\resumeSubHeadingListStart
\resumeSubItem{Resume devops  (github-actions, devops, ci/cd, nginx)}{Developed CD pipeline using github actions which converts latex to pdf and commits to specific branch; reverse proxy was setup to redirect custom sub-domain requests to associated pdf's}
\vspace{2pt}
