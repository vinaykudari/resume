...
\section{Experience}
  ...
  \resumeSubheading{Gap Inc}{San Francisco, CA}
    ...
    \resumeItemListStart
        ...
        \resumeItemClean
          {Leading the development of a GraphQL based data access layer to retrieve terabyte scale data from a data lake}
       \resumeItemListEnd
...
\resumeSubItem{Full text search engine (search, information-retrieval)}{Developed a query parser to transform search query into boolean expression; Optimized the text retrieval by creating inverted index and performed batch processing.}
\vspace{2pt}
