...
\section{Relevant Projects}
    \resumeSubHeadingListStart
        \projectheading{Smart Broker | Deep/Reinforcement Learning, Computer Vision}{\href{https://github.com/vinaykudari/eureka-bot}{code}}{}
            \resumeItemListStart
                \resumeItemClean
                    {Designed custom environment for crypto trading, training the networks on visual technical indicators like Candelstick, RSI}
                \resumeItemClean
                    {Used LSTM/Transformers as function approximators and trained the agent using Actor Critic algorithms to optimise net gains}
            \resumeItemListEnd
