...
\section{Relevant skills}
	{\textbf{Python, JAVA, SQL}, \textit{Django, Spring Boot, PySpark, Docker, Kubernetes, Git, Redis, Kafka, Jenkins}, \textbf{GCP, AWS}}
\vspace{-2pt}

\section{Experience}
  \resumeSubHeadingListStart
  \resumeSubheading{Gap Inc}{San Francisco, CA}
    {Sr. Software Engineer  \(|\) \textbf{java, spring boot, graphql, azure, llm, kafka, devops}}{July 2023 - Present}
    \resumeItemListStart
        \resumeItemClean
        ...
        \resumeItemClean
          {Engineered a custom library for spring boot and GraphQL, optimizing database queries for efficient data retrieval from a large data lake, enhancing performance}
        \resumeItemClean
  ...
  \resumeSubheading{Amazon Web Services}{Palo Alto, CA}
    {Software Development Engineer  \(|\) \textbf{cdk, dynamo, glue, lambda, sqs, vpc, serverless}}{Dec 2022 - June 2023}
    \resumeItemListStart
        \resumeItemClean
...
\vspace{2pt}
\resumeSubItem{Deep learning based serverless rest api (vision, rest-api, cloud-run, ci/cd)}{Created synthetic face mask dataset and developed automated pipeline to build, test and deploy trained model in a docker container to google cloud run}
\resumeSubHeadingListEnd
\vspace{-5pt}
